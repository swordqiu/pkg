...
func TestIsFunction(t *testing.T) {
	cases := []struct {
		...
		{s: "in@100:allow 0.0.0.0/0 any", s2: "in@100:allow any", isWildMatch: true},
		{s: "in:allow 0.0.0.0/0 tcp", s2: "in:allow tcp"},
		{s: "in@101:allow 0.0.0.0/0 tcp", s2: "in@100:allow tcp"},
		{s: "in:allow 0.0.0.0/0 udp", s2: "in:allow udp"},
		{s: "in@50:allow 0.0.0.0/0 udp", s2: "in@50:allow udp"},
		{s: "in:allow 0.0.0.0/0 icmp", s2: "in:allow icmp"},
		{s: "in:allow 10.0.8.0/24 any", s2: "in:allow 10.0.8.0/24 any"},
		{s: "in@300:allow 10.0.8.0/24 any", s2: "in@100:allow 10.0.8.0/24 any"},
		...
		{s: "in@1:allow 10.0.11.0/24 icmp", s2: "in:allow 10.0.11.0/24 icmp"},
		{s: "in@2:allow 10.0.11.0/24 icmp", s2: "in@2:allow 10.0.11.0/24 icmp"},
